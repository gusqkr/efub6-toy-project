...
const BarChartIcon = RiBarChartGroupedFill;

const TextIcon = IoIosText;
const TweetIcon = FaRetweet;
    ...
    <>
      ...
      <DetailContainer>
        ...
        <MidContainer>
          ...
          <Translation>Translate post</Translation>
        </MidContainer>
        <WriteDate>12:52 AM, May 11, 2024</WriteDate>
        <BarChart>
          <BarChartIcon />
        ...
        <ReplyContainer>
          <Profile
            ...
            alt="프로필"
          />
          <TextSection placeholder="Post your reply" />
