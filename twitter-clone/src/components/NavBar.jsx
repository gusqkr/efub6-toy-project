...
const BellIcon = styled(GoBell)`
  font-size: 20px;
`;
const MailIcon = styled(FiMail)`
  font-size: 20px;
`;
const BoxIcon = styled(MdOutlineCheckBox)`
  font-size: 20px;
`;
const ListIcon = styled(RiFileListLine)`
  font-size: 20px;
`;
...
const BookMarkIcon = styled(FaRegBookmark)`
  font-size: 20px;
`;
const PeopleIcon = styled(IoPeopleOutline)`
  font-size: 20px;
`;
...
const UserIcon = styled(FaRegUser)`
  font-size: 20px;
`;
const MoreIcon = styled(IoEllipsisHorizontalCircle)`
  font-size: 20px;
`;
...
const MiniProfile = styled.div`
  ...
  padding: 40px 0;
`;
const MiniProfileLeft = styled.div`
  display: flex;
  gap: 10px;
  align-items: center;
`;
...
const TweetId = styled.p`
  font-size: 10px;
  color: #9a9a9a;
`;

function NavBar({ onChangeFeed }) {
  return (
    <NavContainer>
      <Logo />
      <NavgationBar>
        <IconCard onClick={() => onChangeFeed(true)}>
          <HomeIcon />
        ...
        <IconCard>
          <PeopleIcon />
          <IconText>Communities</IconText>
        </IconCard>
        <IconCard>
          <TwitterIcon />
          <IconText>Premium</IconText>
        </IconCard>
        <IconCard onClick={() => onChangeFeed(false)}>
          <UserIcon />
