...
import { RiEarthFill, RiListRadio, RiProgress8Fill } from "react-icons/ri";
import { LuImage, LuCalendarClock } from "react-icons/lu";
import { MdOutlineGifBox } from "react-icons/md";
import { FaRegFaceSmile } from "react-icons/fa6";
import { FiMapPin } from "react-icons/fi";
import { IoAddCircleOutline } from "react-icons/io5";

const PostingSectionContainer = styled.div`
  display: flex;
  flex-direction: row;
  padding: 18px 20px;
  padding-bottom: 0;
...
const ReplyAuthSection = styled.div`
  display: flex;
  color: #0590c7;
  font-size: 10px;
  border-bottom: solid 1px #9a9a9a;
...
const EarthIcon = styled(RiEarthFill)`
  padding: 7px 5px;
`;
...
`;
const ButtonLeftPart = styled.div`
  display: flex;
  color: #0590c7;
  font-size: 18px;
  padding: 10px;
...
const ButtonRightPart = styled.div`
  display: flex;
  padding: 10px;
  gap: 7px;
  color: #0590c7;
...
const GifIcon = MdOutlineGifBox;
const ListIcon = RiListRadio;
const SmileIcon = FaRegFaceSmile;
const CalendarIcon = LuCalendarClock;
const MapIcon = FiMapPin;
const ProgressIcon = RiProgress8Fill;
const AddIcon = IoAddCircleOutline;
  ...
  return (
    <PostingSectionContainer>
      ...
      <ContentContainer>
        ...
        <ReplyAuthSection>
          <EarthIcon />
          <AuthText>Everyone can reply</AuthText>
        </ReplyAuthSection>
        <ButtonSection>
          <ButtonLeftPart>
            <ImageIcon />
